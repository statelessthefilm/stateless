...
jQuery(document).ready(function($) {
	...
	$('#counter-1').animateNumber({ number: 13 }, 2000 );
	$('#counter-2').animateNumber({ number: 2 }, 2000 );
	$('#counter-3').animateNumber({ number: 1 }, 2000 );
	},{accX: 0, accY: -200});
...
var clock;
	...
	futureDate = new Date("April 23, 2021 01:10:00")
